...
const CHARACTER_PROMPTS = {
    ...
    eunsu: {
        ...
        hidden: "13번의 반복 실험 총괄 책임자. 기억을 지우면 피험자가 다시 통제권 안으로 돌아온다고 믿는 병적 의존과 통제욕.",
...
const FLAG_MEMORIES = [
    ...
    { flag: "met_sea", char: "sea", text: "반장 한세아가 학교를 안내해줌. '너를 다 알고 있어'라고 말함." },
...
const FALLBACK_RESPONSES = {
    ...
    interrogation: {
        ...
        eunsu: [
            ...
            { text: "선생님 지금 꽤 실망했어. 알고 있지?", emotion: "angry", danger_delta: 3 }
        ],
    ...
    nightmare: {
        lines: [
            "*복도를 꺾을 때마다 같은 사물함 번호가 돌아온다.*",
            "*교실 문을 열면 분필 가루 냄새가 먼저 밀려오고 같은 책상이 다시 놓여 있다.*",
