...
Object.assign(SCENARIO[5], {
    ...
    // "기억 지우면 또 만날 수 있어."
    "day5_lunch_left_10": {
        characters: { left: "yuna_weak", center: "sea_broken_smile" },
        unskippable: true,
    ...
    "day5_lunch_left_choice": {
        ...
        choices: [
            ...
            { next: "day5_lunch_left_c3_1", setFlags: ["cage_route_sea"], stats: { sea: { affinity: 10 } } }
        ],
    ...
    "day5_lunch_pills_2": {
        ...
        unskippable: true,
        choices: [
            { next: "day5_lunch_pills_pink_1" },
            { next: "day5_lunch_pills_black_1" }
        ]
    },
    ...
    "day5_lunch_seolhwa_1": {
        ...
        characters: { left: "yuna_weak", center: "seolhwa_ghost" },
        unskippable: true,
    ...
    "day5_lunch_seolhwa_guide_5": {
        characters: { left: "yuna_worried", center: "seolhwa_fading" },
        unskippable: true,
    ...
    // 은수 등장
    "day5_lunch_eunsu_5": {
        characters: { left: "yuna_weak", center: "eunsu_obsessed" },
        glitch: { noise: true },
        unskippable: true,
    ...
    "day5_lunch_eunsu_7": {
        characters: { left: "yuna_weak", center: "eunsu_warm" },
        unskippable: true,
    ...
    "day5_lunch_eunsu_24": {
        ...
        unskippable: true,
        choices: [
            { next: "day5_lunch_eunsu_25", stats: { eunsu: { affinity: -3 }, yuna: { affinity: 3 } } },
            { next: "day5_lunch_eunsu_25", stats: { eunsu: { affinity: 3 } } },
            { next: "day5_lunch_eunsu_25", stats: { seolhwa: { affinity: 2 } } }
        ]
    },
    // "...돌아와."
    "day5_lunch_eunsu_25": {
    ...
    "day5_lunch_eunsu_final": {
        ...
        choices: [
            ...
            { next: "day5_lunch_final_resist", setFlags: ["chose_together"], stats: { seolhwa: { affinity: 10 } } }
        ],
