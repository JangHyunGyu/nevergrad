...
BACKGROUNDS = [
    ...
    },
    {
        ...
        "prompt": "Visual novel background illustration, vivid digital cel shading, DDLC style background, no characters, wide 16:9 composition, 1920x1080 resolution, cream wall school main building 1st floor east end nurse's office interior, two beds partitioned by white curtains with clean white sheets, glass door stainless steel medicine cabinet with medicine bottles and bandages, wooden desk with computer monitor thermometer blood pressure meter, human anatomy poster on wall, aluminum frame glass window with lace curtains letting in bright light, beige polished linoleum floor, square fluorescent ceiling lights, clean and sterile but somehow unsettling clinical atmosphere",
        "negative": "low quality, blurry, 3D rendering, photorealistic photo, watermark, signature, text, letters, characters, numbers, logo, sign, nameplate, people, person, character, multiple angles"
    },
    {
        "name": "rooftop.png",
        "prompt": "Visual novel background illustration, vivid digital cel shading, DDLC style background, no characters, wide 16:9 composition, 1920x1080 resolution, cream main building 4th floor rooftop, green chain-link safety fence on both sides 180cm tall, open clear sky with cumulus clouds beyond fence, below are full-bloom cherry blossom trees and schoolyard with red urethane track, reddish-brown brick wall and village scenery in distance, old wooden bench in left corner, concrete floor with rain stains and drain, gray metal fire door for rooftop access at rear, towel fluttering on fence in wind, peaceful afternoon sunshine and feeling of liberation",
        "negative": "low quality, blurry, 3D rendering, photorealistic photo, watermark, signature, text, letters, characters, numbers, logo, sign, nameplate, people, person, character, multiple angles"
    },
    {
        "name": "stairway.png",
...
def generate_image(prompt, negative_prompt, output_path):
    ...
    full_prompt = prompt + ". Do not include any text, letters, numbers, logos, signs, watermarks, signatures, or nameplates in the image."
    payload = {
        "instances": [
            {"prompt": full_prompt}
        ],
