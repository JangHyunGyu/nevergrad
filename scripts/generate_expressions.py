...
CHARACTERS = {
    ...
    'sea': {
        ...
        'expressions': {
            ...
            'sea_yandere': '오른쪽 리본이 풀려 반쯤 내려옴, 비대칭 동공 한쪽이 핀홀처럼 수축 한쪽은 확대, 피부톤이 불건강한 창백 비정상적인 핑크 홍조, 귀까지 찢어질 듯 넓은 미소 이빨이 전부 보임, 고개를 왼쪽으로 25도 부자연스럽게 기울임, 교복 스타일 사복에 미세한 붉은 얼룩, 오른손을 등 뒤에 숨기고 왼손은 정면을 향해 뻗는 자세. 조명: 핑크와 핏빛 빨강이 교차하는 조명.',
    ...
    'yuna': {
        ...
        'expressions': {
            ...
            'yuna_weak': '극도로 마르고 가냘픈 체형 쇄골이 도드라짐, 머리카락이 기름지고 엉키고 흐트러짐 땋은머리 장식 풀림, 눈 초점이 안 맞고 풀려서 반쯤 감긴 상태 눈 아래 진한 다크서클, 병적으로 창백한 피부 입술이 갈라지고 건조함, 찢어지고 더러워진 블레이저 교복 스타일 사복 가디건 없음, 오른팔 안쪽에 반창고와 주사 바늘 자국, 힘없이 한쪽으로 기울어져 축 처진 자세. 조명: 어둡고 병적인 녹색-흰색 형광등 조명.',
        }
    },
    'seolhwa': {
...
배경: 단색 순수 마젠타 크로마키 배경 #FF00FF 유지.
